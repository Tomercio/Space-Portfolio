export const projects = [
  {
    ...
    description:
      "A Phishing Detector application programmed with Python.Instractions: You insert the email into the machine, choose in which format to get it, and then get the result. The results show you suspicious links, urgency words, and give you score at the end if this email is phishi or not.",
    image: "/images/pd.png",
